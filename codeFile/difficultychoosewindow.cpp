...
DifficultyChooseWindow::DifficultyChooseWindow(QWidget *parent) : QWidget(parent)
{
    ...
    connect(simpleBtn,&MyPushButton::clicked,[=](){
        ...
        QTimer::singleShot(200,this,[=](){
            ...
            this->hide();
            emit stopSound();
            simpleWindow->setOneTime(3);//设置老鼠出现的时间
            simpleWindow->setGameTime(60);//设置游戏时间
            simpleWindow->startGame();
            simpleWindow->show();
    ...
    connect(normalBtn,&MyPushButton::clicked,[=](){
        ...
        QTimer::singleShot(200,this,[=](){
            ...
            this->hide();
            emit stopSound();
            normalWindow->setOneTime(2);//设置老鼠出现的时间
            normalWindow->setGameTime(60);//设置游戏时间
            normalWindow->startGame();
            normalWindow->show();
        });
        //监听排行榜窗口的返回信号并返回
    ...
    connect(diffBtn,&MyPushButton::clicked,[=](){
        ...
        QTimer::singleShot(200,this,[=](){
            ...
            this->hide();
            emit stopSound();
            diffWindow->setOneTime(2);//设置老鼠出现的时间
            diffWindow->setGameTime(60);//设置游戏时间
            diffWindow->startGame();
            diffWindow->show();
        });
        //监听排行榜窗口的返回信号并返回
